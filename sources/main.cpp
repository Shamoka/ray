...
int main(int ac, char **av)
{
  ...
  Plane  *p1 = new Plane(Vec3f(1, 10, 1), Vec3f(0, 5, 75), Color(255, 255, 255), 0.1);
  ...
  Light *l1 = new Light(Vec3f(10, 0, 40), Color(255, 255, 255));
  Light *l2 = new Light(Vec3f(10, 10, 50), Color(255, 255, 255));
